...
#define SYS_SBRK      ( 0x08 )
#define SYS_PCRT      ( 0x09 )
#define SYS_PATT      ( 0x0a )
#define SYS_PID       ( 0x0b )
#define SYS_SWS       ( 0x0c )
...
extern int _write( int fd, const void* x, size_t n );
// read  n bytes into x from the file descriptor fd; return bytes read
extern int  _read( int fd,       void* x, size_t n );
...
extern int  set_priority(int prio);
extern int  get_priority();
